...
class DQN(nn.Module):
    def __init__(self, args, action_space):
        ...
        if args.architecture == 'canonical':
            ...
            self.convs = nn.Sequential(nn.Conv2d(9, 16, 3, stride=1, padding='same'), nn.ReLU(),
                                       nn.Conv2d(16, 32, 4, stride=2, padding=0), nn.ReLU(), #stride 1
                                       nn.Conv2d(32, 64, 3, stride=2, padding=0), nn.ReLU()) #kernel size 3 , stride 2, stable version had kernel 4
