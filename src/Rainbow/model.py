...
class DQN(nn.Module):
    def __init__(self, args, action_space):
        ...
        if args.architecture == 'canonical':
            ...
            self.convs = nn.Sequential(nn.Conv2d(9, 32, 5, stride=1, padding='same'), nn.LeakyReLU(),
                                       nn.Conv2d(32, 64, 5, stride=5), nn.LeakyReLU(), #stride 1
                                       nn.Conv2d(64, 64, 5, stride=1, padding='same'), nn.LeakyReLU()) #kernel size 3 , stride 2, stable version had kernel 4
