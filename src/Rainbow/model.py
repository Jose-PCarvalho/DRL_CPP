...
class DQN(nn.Module):
    def __init__(self, args, action_space):
        ...
        if args.architecture == 'canonical':
            ...
            self.convs = nn.Sequential(nn.Conv2d(9, 32, 4, stride=2, padding=2), nn.LeakyReLU(),
                                       nn.Conv2d(32, 64, 4, stride=2), nn.LeakyReLU(), #stride 1
                                       nn.Conv2d(64, 64, 4, stride=2), nn.LeakyReLU()) #kernel size 3 , stride 2, stable version had kernel 4
